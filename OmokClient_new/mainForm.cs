...
namespace myForm
{
    ...
    public partial class mainForm : Form
    {
        ...
        string _port = "9000"; // TODO : Config로 빼기
        ...
        private void button_Regist_Click(object sender, EventArgs e)
        {
            ...
            var hiveResponse = client.PostAsJsonAsync(hiveAddress + "/AuthUser", // TODO : 라우팅 주소 확인하기
        ...
        private void button_Login_Click(object sender, EventArgs e)
        {
            ...
            // Hive 서버에 로그인 요청
            HttpClient hive = new();
            var hiveResponse = hive.PostAsJsonAsync(hiveAddress + "/AuthUser", // TODO : 라우팅 주소 확인하기
                                                                     new { Email = textBox_ID.Text, Password = textBox_PW.Text }).Result;
            if (hiveResponse.StatusCode != HttpStatusCode.OK)
            {
            ...
            // Game 서버에 로그인 요청
            HttpClient game = new();
            var gameResponse = game.PostAsJsonAsync(gameAddress + "/AuthUser", // TODO : 라우팅 주소 확인하기
