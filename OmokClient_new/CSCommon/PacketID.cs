...
namespace CSCommon
{
    ...
    public class PacketID
    {
        ...
        public const UInt16 LoginResponseSocketServer = 1007;
        public const UInt16 ReqRegister = 1004;
        public const UInt16 ValidateUserTokenRequest = 1105;
        ...
        public const UInt16 NotifyRoomUserLeft = 1023;

        public const UInt16 ReqRoomChat = 1026;
        public const UInt16 ResRoomChat = 1027;
        public const UInt16 NtfRoomChat = 1028;
        public const UInt16 ReqMatch = 1029;
        public const UInt16 MatchingResponse = 1030;
